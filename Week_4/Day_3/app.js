...
app.get('/', (req, res, next) => {
  //if you want to skip a layout, pass an object with layout: false
  /*   let data = {
    layout: false,
  }; */
...
//First example, for handlebars intro and helpers
/* app.get('/', (req, res, next) => {
  let data = {
    name: 'André',
    bootcamp: 'WebDev',
    address: {
      street: 'Doca Jardim do Tabaco',
      number: 87,
    },
    cities: ['Lisbon', 'Madrid', 'Hong Kong', 'Chicago', 'São Paulo', 'Tokyo', 'Seixal'],
  };
